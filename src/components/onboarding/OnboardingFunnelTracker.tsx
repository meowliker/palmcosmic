...
const STEP_META: Record<string, { stepId: string; stepName: string; progress?: number; funnel?: string }> = {
  ...
  "/onboarding/gender": { stepId: "gender", stepName: "Gender", progress: 64 },
  "/onboarding/birthday": { stepId: "birthday", stepName: "Birthday", progress: 70 },
  "/onboarding/birth-time": { stepId: "birth_time", stepName: "Birth Time", progress: 76 },
  "/onboarding/birthplace": { stepId: "birthplace", stepName: "Birthplace", progress: 82 },
  "/onboarding/step-5": { stepId: "loading_analysis", stepName: "Loading Analysis", progress: 84 },
  "/onboarding/step-6": { stepId: "chart_preparing", stepName: "Chart Preparing", progress: 86 },
  "/onboarding/step-7": { stepId: "priority_area", stepName: "Priority Area", progress: 84 },
