...
const STEP_META: Record<string, { stepId: string; stepName: string; progress?: number; funnel?: string }> = {
  ...
  "/onboarding/step-7": { stepId: "generic_question_step_7", stepName: "Relationship Status", progress: 56 },
  "/onboarding/step-8": { stepId: "generic_question_step_8", stepName: "Future Goals", progress: 64 },
  "/onboarding/step-9": { stepId: "generic_question_step_9", stepName: "Color Preference", progress: 72 },
  "/onboarding/step-10": { stepId: "generic_question_step_10", stepName: "Element Preference", progress: 80 },
  "/onboarding/step-11": { stepId: "generic_question_redirect", stepName: "Generic Question Redirect", progress: 88 },
  "/onboarding/step-12": { stepId: "generic_chart_reveal", stepName: "Chart Reveal", progress: 92 },
