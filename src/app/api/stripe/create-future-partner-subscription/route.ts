...
const FLOW = "future_partner";
const REPORT_KEY = "future_partner";
const FEATURE = "futurePartnerReport";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const successPath = appendQuery(
      normalizeRelativePath(body.successPath, "/future-partner"),
      { payment: "success", product: REPORT_KEY }
    );
    const cancelPath = appendQuery(
      normalizeRelativePath(body.cancelPath, "/onboarding/future-partner/paywall"),
      { cancelled: "true" }
    );
    ...
    const metadata: Record<string, string> = {
      ...
      productName: "Future Partner Report",
    };
      ...
      line_items: [
        {
          ...
          price_data: {
            ...
            product_data: {
              ...
              description: "Unlock your Future Partner Report during the trial.",
            },
          },
        },
        {
    ...
    await sendMetaConversionEvent({
      ...
      currency: "USD",
      contentName: "Future Partner Report Trial",
    ...
    console.error("Future partner subscription checkout error:", error);
    return NextResponse.json(
