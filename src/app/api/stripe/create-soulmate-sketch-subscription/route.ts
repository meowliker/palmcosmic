...
const FLOW = "soulmate_sketch";
const REPORT_KEY = "soulmate_sketch";
const FEATURE = "soulmateSketch";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const successPath = appendQuery(
      normalizeRelativePath(body.successPath, "/soulmate-sketch"),
      { payment: "success", product: REPORT_KEY }
    );
    const cancelPath = appendQuery(
      normalizeRelativePath(body.cancelPath, "/onboarding/soulmate-sketch/paywall"),
      { cancelled: "true" }
    );
    ...
    const metadata: Record<string, string> = {
      ...
      productName: "Soulmate Sketch & Reading",
    };
      ...
      line_items: [
        {
          ...
          price_data: {
            ...
            product_data: {
              ...
              description: "Unlock your Soulmate Sketch & Reading during the trial.",
            },
          },
        },
        {
    ...
    await sendMetaConversionEvent({
      ...
      currency: "USD",
      contentName: "Soulmate Sketch & Reading Trial",
    ...
    console.error("Soulmate sketch subscription checkout error:", error);
    return NextResponse.json(
