...
const FLOW = "future_prediction";
const REPORT_KEY = "prediction_2026";
const FEATURE = "prediction2026";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const successPath = appendQuery(
      normalizeRelativePath(body.successPath, "/prediction-2026"),
      { payment: "success", product: REPORT_KEY }
    );
    const cancelPath = appendQuery(
      normalizeRelativePath(body.cancelPath, "/onboarding/future-prediction/paywall"),
      { cancelled: "true" }
    );
    ...
    const metadata: Record<string, string> = {
      ...
      productName: "2026 Prediction Report",
    };
      ...
      line_items: [
        {
          ...
          price_data: {
            ...
            product_data: {
              ...
              description: "Unlock your 2026 Prediction Report during the trial.",
            },
          },
        },
        {
    ...
    await sendMetaConversionEvent({
      ...
      currency: "USD",
      contentName: "2026 Prediction Report Trial",
      contentIds: [REPORT_KEY],
    ...
    console.error("Future prediction subscription checkout error:", error);
    return NextResponse.json(
