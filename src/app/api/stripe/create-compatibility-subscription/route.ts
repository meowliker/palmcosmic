...
const FLOW = "compatibility";
const REPORT_KEY = "compatibility";
const FEATURE = "compatibilityTest";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const successPath = appendQuery(
      normalizeRelativePath(body.successPath, "/compatibility"),
      { payment: "success", product: REPORT_KEY }
    );
    const cancelPath = appendQuery(
      normalizeRelativePath(body.cancelPath, "/onboarding/compatibility/paywall"),
      { cancelled: "true" }
    );
    ...
    const metadata: Record<string, string> = {
      ...
      productName: "Compatibility Report",
    };
      ...
      line_items: [
        {
          ...
          price_data: {
            ...
            product_data: {
              ...
              description: "Unlock your Compatibility Report during the trial.",
            },
          },
        },
        {
    ...
    await sendMetaConversionEvent({
      ...
      currency: "USD",
      contentName: "Compatibility Report Trial",
    ...
    console.error("Compatibility subscription checkout error:", error);
    return NextResponse.json(
